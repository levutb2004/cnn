...
no_data_values = {
    "vnm": {
        ...
        "vnm_nightlights": -999999,
        "vnm_elevation": -999999,

        "vnm_highway_dist": -99999,
        "vnm_road_intr_dist": -99999,
        "vnm_waterbodies_dist": -99999,
        "vnm_inland_water_dist": -99999,
        "vnm_coastline_dist": -99999,
        "vnm_wdpa_dist": -99999,
...
norms = {
    "vnm": {
        "buildings_google": (2.22611458099921, 9.15974825687129),
        "buildings_maxar": (2.22611458099921, 9.15974825687129),
        "buildings_google_mean_area": (129.329806158893, 437.179126209948),
        "buildings_maxar_mean_area": (129.329806158893, 437.179126209948),
        "buildings_merge_mean_area": (129.329806158893, 437.179126209948),
        "built_s": (129.329806158893, 437.179126209948),
        "built_v": (555.272009204423, 2977.85581655506),
        "vnm_nightlights": (1.49002085197618, 14.4640868395946),
        "vnm_elevation": (391.790460989229, 426.240747204649),
        "vnm_highway_dist": (2.2489102353232, 2.76824314420968),
        "vnm_road_intr_dist": (4.88284614619926, 4.23967356184671),
        "vnm_waterbodies_dist": (2.57924168237664, 2.6387763659301),
        "vnm_inland_water_dist": (2.27419105569497, 2.39202543445929),
        "vnm_coastline_dist": (106.564262415351, 105.318075993327),
        "vnm_wdpa_dist": (315.784707961599, 100.755002898206),
        "vnm_esalc_11": (0.12341069779053, 1.54892859064295),
        "vnm_esalc_40": (1.38184020086607, 3.45145626214385),
        "vnm_esalc_130": (2.94096959600879, 5.20711980241594),
        "vnm_esalc_140": (19.9843877668471, 15.257946548728),
        "vnm_esalc_150": (107.326284107885, 67.8814382028629),
        "vnm_esalc_160": (12.6698711355845, 9.9587895729312),
        "vnm_esalc_190": (11.8997127332711, 10.8368041203837),
        "vnm_esalc_200": (190.239056557416, 151.293204984953),
        "vnm_bsgme": (0.061219892535717, 0.239733221088843),
        "vnm_bsgme_dst": (2.7786090700322, 3.00198394431394),
        "slope": (8.97991783605555, 9.27226671313622)
    },
    "tza": {
...
metadata = {
    "vnm": {
        ...
        #"rst_pop_gt_path": f'{root_path}VNM/covariates/selected_sample.tif'
    },
    "tza": {
        "wp_no_data": [0, 1],
    ...
    "rwa":{
        ...
        "rst_pop_gt_path": f'{root_path}RWA/covariates/selected_sample.tif'
    },
    "moz":{
        "wp_no_data": [0, 1],
        "wp_covariates_no_data": -9999,
